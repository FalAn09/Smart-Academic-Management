...
export class CreateProgramDto {
  ...
  @ApiProperty({
    example: 'Ingeniería en Sistemas de Información',
  ...
  @ApiPropertyOptional({
    example: 'Formación de profesionales en el área de software...',
  ...
  @ApiProperty({
    example: 'Ingeniero/a en Sistemas',
    description: 'Título que otorga',
  })
  @IsString()
  @IsNotEmpty()
  degreeTitle: string;
